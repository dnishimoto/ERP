...
$class="ProjectManagementMilestone"; ###_xx_
$concrete="projectManagementMilestone"; ###_yy_
$domain="ProjectManagementMilestoneDomain"; ##_dd_
$modulename="ProjectManagementMilestone"; ###_zz_
