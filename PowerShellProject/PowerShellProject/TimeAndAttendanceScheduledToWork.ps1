...
$class="TimeAndAttendanceScheduledToWork"; ###_xx_
$concrete="timeAndAttendanceScheduledToWork"; ###_yy_
$domain="TimeAndAttendanceScheduledToWorkDomain"; ##_dd_
$modulename="TimeAndAttendanceScheduledToWork"; ###_zz_
