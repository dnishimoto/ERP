...
$class="ProjectManagementWorkOrder"; ###_xx_
$concrete="projectManagementWorkOrder"; ###_yy_
$domain="ProjectManagementWorkOrderDomain"; ##_dd_
$modulename="ProjectManagementWorkOrder"; ###_zz_
