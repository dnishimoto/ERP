...
$class="ShipmentsDetail"; ###_xx_
$concrete="shipmentsDetail"; ###_yy_
$parentclass="Shipments"; ###_zz_
$parentconcrete="shipments"; ###_zz2_
#################################################################################
...
public interface I_xx_Repository
	...
	Task<List<_xx_>> GetEntitiesBy_zz_Id(long _zz2_Id);
    }
";
...
$content1="    public class _xx_Repository: Repository<_xx_>, I_xx_Repository
 ...
 public async Task<List<_xx_>> GetEntitiesBy_zz_Id(long _zz2_Id)
        {
            var query = 
...
$content5="public class Fluent_xx_Query:IFluent_xx_Query
 ...
 public async Task<_xx_> GetEntityById(long _yy_Id) {
        ...
        public async Task_xx_> GetEntityByNumber(long _yy_Number) {
