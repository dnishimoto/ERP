...
$class="TaxRatesByCode"; ###_xx_
$concrete="taxRatesByCode"; ###_yy_
...
public async Task<_xx_View> GetEntityById(long _yy_Id)
        {
...
$content7="        [HttpPost]
        ...
        public async Task<IActionResult> Add_xx_([FromBody]_xx_View view)
        {
            ...
            invMod._xx_.AddComment(_yy_).Apply();
        ...
        {
            _xx_Module invMod = new _xx_tModule();
            _xx_ _yy_ = await invMod._xx_.Query().MapToEntity(view);
            invMod._xx_.DeleteComment(_yy_).Apply();
