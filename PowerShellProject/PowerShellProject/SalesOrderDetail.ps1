...
$domain="SalesOrderDetailDomain"; ##_dd_
$modulename="SalesOrderDetail"; ###_zz_
...
public interface I_xx_Repository
    {
		...
		Task<IList<_xx_>> GetObjectsQueryable(Expression<Func<_xx_, bool>> predicate, string include);
 ...
 public class _xx_Repository: Repository<_xx_>, I_xx_Repository
  ...
  public async Task<_xx_>GetEntityById(long _yy_Id)
         ...
         public async Task<_xx_> GetEntityByNumber(long _yy_Number)
        {
		 ...
		 public async Task<IList<_xx_>> GetObjectsQueryable(Expression<Func<_xx_, bool>> predicate,string include)
       {
            try
            {
