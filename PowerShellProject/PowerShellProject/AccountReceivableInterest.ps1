...
$class="AccountReceivableInterest"; ###_xx_
$concrete="accountReceivableInterest"; ###_yy_
$domain="AccountReceivableInterestDomain"; ##_dd_
$modulename="AccountReceivableInterest"; ###_zz_
...
public interface I_xx_Repository
    {
        Task<_xx_> GetEntityById(long __yy_Id);
		Task<List<_xx_>> GetObjectsQueryable(Expression<Func<_xx_, bool>> predicate, string include);
 ...
 public class _xx_Repository: Repository<_xx_>, I_xx_Repository
  ...
  public async Task<_xx_>GetEntityById(long _yy_Id)
         ...
         public async Task<_xx_> GetEntityByNumber(long _yy_Number)
        {
		 ...
		 public async Task<List<_xx_>> GetObjectsQueryable(Expression<Func<_xx_, bool>> predicate,string include)
       {
            try
            {
...
$content3="using ERP_Core2.AutoMapper;
using ERP_Core2.Services;
using lssWebApi2.EntityFramework;
...
$content4="using ERP_Core2.AccountPayableDomain;
using ERP_Core2.Services;
using lssWebApi2.EntityFramework;
using System.Collections.Generic;
using System;
...
$content5="using ERP_Core2.AutoMapper;
using ERP_Core2.Services;
using lssWebApi2.EntityFramework;
using lssWebApi2.Enumerations;
using System.Collections.Generic;
...
namespace ERP_Core2._dd_
{
public class Fluent_xx_Query:IFluent_xx_Query
    {
...
$content6="using ERP_Core2.AutoMapper;
using ERP_Core2.Services;
using lssWebApi2.EntityFramework;
using lssWebApi2.Enumerations;
using System.Collections.Generic;
...
$content8="using ERP_Core2.AbstractFactory;
using ERP_Core2._dd_;
using System;
using System.Collections.Generic;
using System.Linq;
