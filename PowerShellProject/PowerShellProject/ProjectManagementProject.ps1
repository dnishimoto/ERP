...
$class="ProjectManagementProject"; ###_xx_
$concrete="projectManagementProject"; ###_yy_
$domain="ProjectManagementProjectDomain"; ##_dd_
$modulename="ProjectManagementProject"; ###_zz_
