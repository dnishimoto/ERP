...
$class="TimeAndAttendanceSchedule"; ###_xx_
$concrete="timeAndAttendanceSchedule"; ###_yy_
$domain="TimeAndAttendanceScheduleDomain"; ##_dd_
$modulename="TimeAndAttendanceSchedule"; ###_zz_
