...
public class FluentPayRollGroupQuery:IFluentPayRollGroupQuery
 ...
 public async Task<PayRollGroupView> MapToView(PayRollGroup inputObject)
  ...
  public async Task<NextNumber>GetNextNumber()
        {
            return await _unitOfWork.payRollGroupRepository.GetNextNumber('PayRollGroupNumber');
        }
...
public async Task<PayRollGroup> GetEntityById(long payRollGroupId)
 ...
 public async Task<PayRollGroupView> GetEntityByNumber(long payRollGroupNumber)
        {
            return _unitOfWork.payRollGroupRepository.GetEntityByNumber(payRollGroupNumber);
        }
}
}
