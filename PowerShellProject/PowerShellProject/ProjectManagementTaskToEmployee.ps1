...
$class="ProjectManagementTaskToEmployee"; ###_xx_
$concrete="projectManagementTaskToEmployee"; ###_yy_
$domain="ProjectManagementTaskToEmployeeDomain"; ##_dd_
$modulename="ProjectManagemenTaskToEmployee"; ###_zz_
