...
namespace lssWebApi2.EntityFramework
{
    public partial class ListensoftwaredbContext : DbContext
    {
        ...
        public virtual DbSet<ProjectManagementMilestone> ProjectManagementMilestone { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountReceivableInterest>(entity =>
            {
                entity.HasKey(e => e.AcctRecInterestId)
                    .HasName("PK_AcctRecInterest");
            ...
            modelBuilder.Entity<ProjectManagementMilestone>(entity =>
            {
                entity.HasKey(e => e.MilestoneId)
                    .HasName("PK_ProjectManagementMilestones");
                ...
                entity.HasOne(d => d.Project)
                    .WithMany(p => p.ProjectManagementMilestone)
