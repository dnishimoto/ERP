...
namespace lssWebApi2.EntityFramework
{
    public partial class ProjectManagementProject
    {
        ...
        {
            ProjectManagementMilestone = new HashSet<ProjectManagementMilestone>();
        ...
        public virtual ICollection<ProjectManagementMilestone> ProjectManagementMilestone { get; set; }
