...
namespace ERP_Core2.AccountsPayableDomain
{
    ...
    public class AccountPayableView
    {
        ...
        public AccountPayableView(AcctPay acctPay)
        {
            ...
            this.SupplierName = acctPay.Supplier.Address.Name;
    ...
    public class AccountPayableRepository : Repository<AcctPay>, IAccountsPayableRepository
    {
        ...
        public async Task<AcctPay> GetAcctPayByPONumber(string poNumber)
        {
            try
            {
                ...
                AcctPay acctPay = await(from e in _dbContext.AcctPay
        ...
        public async Task<AccountPayableView> GetAccountPayableViewByInvoiceId(long? docNumber)
        {
            try
            {
                var query = await (from a in _dbContext.AcctPay
